  ...
  return (
    <section className="w-full" style={{ backgroundColor: "var(--bg-main)" }}>
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
        className="max-w-7xl mx-5 md:mx-auto lg:mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center"
      >
        {/* Left: Image */}
        <motion.div variants={itemVariants} className="relative group">
          <div className="relative overflow-hidden rounded-[10px] shadow-2xl aspect-video md:aspect-auto border-none">
        ...
        <div className="flex flex-col space-y-8 text-center md:text-left">
          <motion.h2
            variants={itemVariants}
            className="text-3xl font-[var(--fw-bold)] md:text-4xl lg:text-5xl leading-tight"
            style={{ color: "var(--text-primary)" }}
          >
      ...
      <div className="w-full">
        <motion.div
          ...
          className="w-full mt-20 py-8 px-6 flex flex-col items-center justify-center gap-4 border-t border-b border-opacity-10"
          style={{
